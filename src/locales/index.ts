...
> = {
  en: {
    ...
    settings: 'Settings',
    close: 'Close',
    loadingPreferencesLabel: 'Getting things ready...',
    theme: 'Theme',
    ...
    dashboard: 'Dashboard',
    insights: 'Insights',
    weeklyInsightsTitle: 'Weekly screen-time pattern',
    weeklyInsightsBody:
      'Review the last 7 days of tracked app usage against your daily limit.',
    weekTabLabel: 'Week',
    monthTabLabel: 'Month',
    allTimeTabLabel: 'All Time',
    monthlyInsightsTitle: 'Monthly progress',
    monthlyInsightsBody:
      'Scan this month by day and spot the dates that stayed under your limit.',
    allTimeInsightsTitle: 'All-time progress',
    allTimeInsightsBody:
      'See your longest streak and the best and worst tracked days saved on this phone.',
    longestStreakLabel: 'Longest streak',
    bestUsageDayLabel: 'Best day',
    worstUsageDayLabel: 'Worst day',
    noAllTimeRecordsLabel: 'No all-time records yet. Keep using tracked apps to build your progress history.',
    limitWasLabel: 'limit was',
    monthTotalLabel: 'Month total',
    voiceNotesMonthLabel: 'Voice notes',
    summaryOnlyMonthLabel:
      'Detailed daily records are not available for this month, so this view is using the saved monthly summary.',
    topInterventionAppLabel: 'Top intervention app',
    dayDetailsLabel: 'Day details',
    totalUsageLabel: 'Total usage',
    usageStatusLabel: 'Status',
    limitHitsLabel: 'Limit hits',
    perAppUsageLabel: 'Per-app usage',
    noUsageRecordedLabel: 'No tracked usage recorded for this day.',
    weekTotalLabel: 'Week total',
    daysUnderLimitLabel: 'Days under limit',
    dailyLimitLineLabel: 'Daily limit',
    noInsightsYetLabel: 'No weekly analytics yet. Use tracked apps and refresh the dashboard to start building history.',
    ...
    underLimitTodayLabel: 'Under limit today',
    overLimitTodayLabel: 'Over limit today',
    voiceInterventionsLabel: 'Voice notes today',
  ...
  ur: {
    ...
    settings: 'ترتیبات',
    close: 'بند کریں',
    loadingPreferencesLabel: 'تیاری ہو رہی ہے...',
    theme: 'تھیم',
    ...
    dashboard: 'ڈیش بورڈ',
    insights: 'Insights',
    weeklyInsightsTitle: 'ہفتہ وار اسکرین ٹائم',
    weeklyInsightsBody:
      'گزشتہ 7 دنوں کی ٹریک شدہ ایپ usage کو اپنی روزانہ حد کے ساتھ دیکھیں۔',
    weekTabLabel: 'ہفتہ',
    monthTabLabel: 'مہینہ',
    allTimeTabLabel: 'کل',
    monthlyInsightsTitle: 'ماہانہ پیش رفت',
    monthlyInsightsBody:
      'اس مہینے کو دن بہ دن دیکھیں اور حد کے اندر رہنے والے دن پہچانیں۔',
    allTimeInsightsTitle: 'کل پیش رفت',
    allTimeInsightsBody:
      'اس فون پر محفوظ longest streak، best day اور worst day دیکھیں۔',
    longestStreakLabel: 'سب سے لمبا تسلسل',
    bestUsageDayLabel: 'بہترین دن',
    worstUsageDayLabel: 'بدترین دن',
    noAllTimeRecordsLabel: 'ابھی all-time records موجود نہیں۔ progress history بنانے کے لیے tracked apps استعمال کرتے رہیں۔',
    limitWasLabel: 'حد تھی',
    monthTotalLabel: 'مہینہ کل',
    voiceNotesMonthLabel: 'وائس نوٹس',
    summaryOnlyMonthLabel:
      'اس مہینے کے تفصیلی روزانہ records دستیاب نہیں، اس لیے saved monthly summary دکھائی جا رہی ہے۔',
    topInterventionAppLabel: 'سب سے زیادہ intervention app',
    dayDetailsLabel: 'دن کی تفصیل',
    totalUsageLabel: 'کل استعمال',
    usageStatusLabel: 'حالت',
    limitHitsLabel: 'Limit hits',
    perAppUsageLabel: 'Per-app usage',
    noUsageRecordedLabel: 'اس دن کوئی tracked usage record نہیں ہوئی۔',
    weekTotalLabel: 'ہفتہ کل',
    daysUnderLimitLabel: 'حد کے اندر دن',
    dailyLimitLineLabel: 'روزانہ حد',
    noInsightsYetLabel: 'ابھی ہفتہ وار analytics موجود نہیں۔ history بنانے کے لیے tracked apps استعمال کریں اور dashboard refresh کریں۔',
    ...
    currentStreakLabel: 'موجودہ تسلسل',
    underLimitTodayLabel: 'آج حد کے اندر',
    overLimitTodayLabel: 'آج حد سے زیادہ',
    voiceInterventionsLabel: 'آج کی وائس نوٹس',
